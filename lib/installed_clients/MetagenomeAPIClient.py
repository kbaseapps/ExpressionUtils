...
class MetagenomeAPI(object):
    ...
    def search_binned_contigs(self, params, context=None):
        ...
        :returns: instance of type "SearchBinnedContigsResult" (num_found -
           ...
           "num_found" of Long
        """
        return self._client.run_job('MetagenomeAPI.search_binned_contigs',
    ...
    def search_contigs_in_bin(self, params, context=None):
        ...
        """
        return self._client.run_job('MetagenomeAPI.search_contigs_in_bin',
                                    [params], self._service_ver, context)
    ...
    def get_annotated_metagenome_assembly(self, params, context=None):
        ...
        """
        return self._client.run_job('MetagenomeAPI.get_annotated_metagenome_assembly',
                                    [params], self._service_ver, context)
    ...
    def search(self, params, context=None):
        ...
        """
        return self._client.run_job('MetagenomeAPI.search',
                                    [params], self._service_ver, context)
    ...
    def search_region(self, params, context=None):
        ...
        """
        return self._client.run_job('MetagenomeAPI.search_region',
                                    [params], self._service_ver, context)
    ...
    def search_contigs(self, params, context=None):
        ...
        """
        return self._client.run_job('MetagenomeAPI.search_contigs',
                                    [params], self._service_ver, context)
    ...
    def get_contig_info(self, params, context=None):
        ...
        """
        return self._client.run_job('MetagenomeAPI.get_contig_info',
                                    [params], self._service_ver, context)
    ...
    def get_feature_type_counts(self, params, context=None):
        ...
        """
        return self._client.run_job('MetagenomeAPI.get_feature_type_counts',
                                    [params], self._service_ver, context)

    def status(self, context=None):
        return self._client.run_job('MetagenomeAPI.status',
