...
class MetagenomeUtils(object):
    ...
    def get_annotated_metagenome_assembly(self, params, context=None):
        ...
        """
        return self._client.run_job('MetagenomeUtils.get_annotated_metagenome_assembly',
                                    [params], self._service_ver, context)

    def get_annotated_metagenome_assembly_features(self, params, context=None):
        """
        :param params: instance of type "getAMAFeaturesParams" (This function
           serves to abstract getting the features from an AMA object. ref -
           string -  workspace reference to AnnotatedMetagenomeAssembly
           object feature_type - string - case insensitive string which
           filters on feature types: accepted feature types include: - "cds"
           - "gene" - "mrna" - "trna" - "repeat_region" - "rrna" only_ids -
           optional boolean (1 or 0)  - whether to include only feature ids,
           default False (0). returns in form [{'id': 1}, {'id': 2}, .....]
           This function returns the features of an
           AnnotatedMetagenomeAssembly as a list of dictionaries.) ->
           structure: parameter "ref" of String, parameter "feature_type" of
           String, parameter "only_ids" of type "boolean" (A boolean - 0 for
           false, 1 for true. @range (0, 1))
        :returns: instance of type "getAMAFeaturesOutput" -> structure:
           parameter "features" of list of unspecified object
        """
        return self._client.run_job('MetagenomeUtils.get_annotated_metagenome_assembly_features',
                                    [params], self._service_ver, context)
